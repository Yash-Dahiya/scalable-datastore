...
import org.example.Task.UserRepo;
...
public class UserService {
    ...
    public Task updateTaskByUser(Integer userId, Integer taskId, Task updatedTask) {
        Optional<User> optionalUser = userRepo.findById(userId);
        if (optionalUser.isPresent()) {
            User user = optionalUser.get();
    ...
    public void deleteTaskByUser(Integer userId, Integer taskId) {
        Optional<User> optionalUser = userRepo.findById(userId);
        if (optionalUser.isPresent()) {
            User user = optionalUser.get();
            List<Task> tasks = user.getTasks();
